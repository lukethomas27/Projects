...
access_letter: ;loads letter from AVAILABLE_CHARSET to registers for usage
...
dash: ;loads dash to bottom right corner
	ldi r18, '-'
	push r18
	rcall lcd_putchar
	pop r18
...
star: ;loads star to bottom right corner when button in pressed
	ldi r18, '*'
	push r18 
	rcall lcd_putchar
	pop r18
...
L_on: ;sets all of the letters to blank except L
	push r19	;L
	rcall lcd_putchar
	pop r19
	push r20	;D
...
D_on: ;sets all of the letters to blank except D
	push r20	;L
	rcall lcd_putchar
	pop r20
	push r19	;D
...
U_on: ;sets all of the letters to blank except U
	push r20	;L
	rcall lcd_putchar
	pop r20
	push r20	;D
...
R_on:;sets all of the letters to blank except R
	push r20	;L
	rcall lcd_putchar
	pop r20
	push r20	;D
...
;section C uses timer 4 and checks whether or not the up or down button is pressed, and based off of that increases or decreases the hex digit in the first box on the LCD
timer4:
	push r27
	push r22
	push ZL
	...
	cpi r22, 'U'	;sent to either go up or go down depending on result 
	breq go_up
	cpi r22, 'D'
	breq go_down

go_down: ;lowers the value
	lds r27, CURRENT_CHARSET_INDEX
	dec r27
	rjmp check_boundary
go_up: ;increases the value
	lds r27, CURRENT_CHARSET_INDEX
	inc r27

check_boundary:		;checks whether or not the digit is in the correct bounds, i.e. it will not go below '0'.
	lds r23, LENGTH
	cp r27, r23
	brsh epilogueT4
	sts CURRENT_CHARSET_INDEX, r27

index_to_charset: ;this function basically loads in the next hex number into the TOP_LINE_CONTENT
